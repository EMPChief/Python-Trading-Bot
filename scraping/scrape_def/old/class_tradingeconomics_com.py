...
import random
from db import DataBaseMongo
class TradingEconomicsCalendar:
    def __init__(self, url="https://tradingeconomics.com/calendar", from_date_str="2018-01-01T00:00:00Z", to_date_str="2024-02-01T00:00:00Z"):
        self.url = url
